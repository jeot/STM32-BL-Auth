...
void CheckApplyStaticProtections(void)
{
  ...
  flash_option_bytes.WRPArea     = OB_WRPAREA_BANK1_AREAA;
  ...
  else
  {
    ...
    int32_t SecSize = flash_option_bytes.WRPEndOffset - flash_option_bytes.WRPStartOffset;
    if (SecSize != BOOT_NB_PAGE_SEC_USER_MEM)
    {
      /*
